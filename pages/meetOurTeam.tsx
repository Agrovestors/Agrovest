...
export const metadata: Metadata = {
  ...
  description:
    "Meet the senior leadership team at Agrovestors Farm Tech, driving innovation and sustainability in agriculture.",
  keywords: ["Agrovestors team", "agriculture leadership", "sustainable farming team"],
  openGraph: {
    title: "Meet Our Team - Agrovestors Farm Tech",
    description:
      "Discover the passionate leaders behind Agrovestors’ mission to revolutionize agriculture.",
    images: [
      {
    ...
    url: "https://your-site.com/meetOurTeam", // Replace with your production URL
    type: "website",
  },
  alternates: {
    canonical: "https://your-site.com/meetOurTeam",
  },
  twitter: {
    card: "summary_large_image",
    title: "Meet Our Team - Agrovestors Farm Tech",
    description: "Learn about the leaders transforming agriculture at Agrovestors.",
...
const teamMembers = [
  ...
  },
  {
    ...
    quote: "Enthusiastic about transforming agriculture!",
    speech:
      "Dr Akaebubechukwu ensures projects align with Agrovest’s mission to transform agriculture.",
  },
];
...
const MeetOurTeam = () => {
  ...
  const schemaData = {
    ...
    member: teamMembers.map((member) => ({
      ...
      image: `https://your-site.com${member.imgSrc}`,
      description: member.speech,
    })),
  };
  ...
  return (
    <div className="meet-our-team-page bg-gray-50 min-h-screen">
      ...
      {/* Hero Section */}
      <section
        className="flex flex-col lg:flex-row items-center justify-between px-6 sm:px-10 lg:px-40 py-20 bg-gradient-to-r from-[#022c22] to-[#065f46] text-white"
        aria-labelledby="hero-heading"
      >
        <div className="w-full lg:max-w-[465px] text-center lg:text-left">
          <h1 id="hero-heading" className="text-4xl sm:text-5xl font-bold mb-4 tracking-tight">
            Meet Our Senior Team
          </h1>
          <p className="text-lg sm:text-xl lg:pr-16 leading-relaxed">
            Our senior management team, including directors across various locations, drives the
            day-to-day operations with passion and expertise.
          </p>
        </div>
      </section>

      {/* Team Section */}
      <section className="team-section py-20 px-6 sm:px-10 lg:px-40" aria-labelledby="team-heading">
        <h2 id="team-heading" className="text-3xl sm:text-4xl font-semibold text-center mb-12 text-gray-800">
          Our Team
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamMembers.map((member, index) => (
            <article
              key={index}
              className="group bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 focus-within:ring-2 focus-within:ring-green-600"
            ...
            >
              <div className="relative w-48 h-48 mx-auto rounded-lg overflow-hidden border-4 border-green-600 mb-4">
                <Image
                  src={member.imgSrc}
                  alt={`${member.name}, ${member.role} at Agrovestors Farm Tech`}
                  width={192}
                  height={192}
              ...
              <p className="text-gray-500 text-sm italic text-center mb-4">&quot;{member.quote}&quot;</p>
              <p className="text-gray-700 text-sm text-center">{member.speech}</p>
            </article>
          ))}
        </div>
      </section>
