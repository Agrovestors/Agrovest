...
export async function generateMetadata(): Promise<Metadata> {
  const goatResearch = {
    title: "Goat Farming Research",
    description: "We're researching sustainable goat farming. Stay tuned for updates!",
  };
  return {
    title: `${goatResearch.title} | Agrovestors Farm Tech`,
    description: goatResearch.description,
    openGraph: {
      title: `${goatResearch.title} - Agrovestors Farm Tech`,
      description: goatResearch.description,
...
export default function GoatProduction() {
  const goatResearch = {
  ...
  return (
    <div className="goat-production-page bg-gradient-to-b from-gray-900 to-green-900 min-h-screen relative overflow-hidden">
